...
def prepare_default_model(default_seed = 42):
    default_config_path = "./stable-diffusion/configs/stable-diffusion/v1-inference.yaml"
    default_ckpt_path = "./stable-diffusion/models/ldm/stable-diffusion-v1/model.ckpt"
